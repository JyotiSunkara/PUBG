...
#include "collision_model_3d.h"		// a really nice open-source, minimal collision library based on coldet that
#include "ray_collision_test.h"		// I stumbled upon rather late in NFZ's development
