all:
	...
	mkdir -p obj/Release/src/3rdparty/glm
	...
	g++ -Wall -DFOUG_OS_UNIX -Os -I../src -I../src/3rdparty -I../src/3rdparty/lodepng -c ../src/objects/hud.cpp -o obj/Release/src/objects/hud.o
